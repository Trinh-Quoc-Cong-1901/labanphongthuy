                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintStyle: CompassUITheme.descriptionTextStyle
                                    .copyWith(
                                  fontSize: 16.csp,
                                ...
                                filled: true,
                                fillColor:
                                    const Color(0xFFFFFAED).withOpacity(0.2),
                                        ...
                                        ? Container(
                                            ...
                                            child: Container(
                                              ...
                                              margin: EdgeInsets.all(
                                                  1.cw), // Inner border effect
                                              decoration: BoxDecoration(
                                                borderRadius:
                                                    BorderRadius.circular(
                                                        15.cr),
                                                color: const Color(
                                                    0xFF01664D), // New solid color
                                              ),
                                              ...
                                              child: Text(
                                                'Nam',
                                                textAlign: TextAlign.center,
                                                style: CompassUITheme
                                                    .cardLabelStyle
                                                    .copyWith(
                                                  fontSize: 16.csp,
                                                  color: CompassUITheme
                                                      .primaryTextColor,
                                                  fontWeight: FontWeight.w500,
                                                ),
                                              ),
