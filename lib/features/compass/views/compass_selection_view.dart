      ...
      child: Container(
        ...
        child: Container(
          ...
          padding: EdgeInsets.symmetric(
            ...
            horizontal: 12.w, // Add horizontal padding to prevent content overflow
          ),
          child: Column(
            ...
            children: [
              ...
              LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final imageSize = maxWidth.clamp(80.0, 140.0); // Min 80, Max 140
                        ...
                        errorBuilder: (context, error, stackTrace) {
                          return Container(
                            ...
                            child: Icon(
                              ...
                              color: CompassUITheme.cardLabelColor.withValues(alpha: 0.7),
                            ),
                          );
                        },
                      ),
