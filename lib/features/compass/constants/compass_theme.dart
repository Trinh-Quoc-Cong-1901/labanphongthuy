...
class CompassTheme {
  ...
  static const Color compassAccentColor = Color(0xFFFFCD45); // Yellow/gold for center
  static const Color northIndicatorColor = Color(0xFFFF1616); // Bright red for north
